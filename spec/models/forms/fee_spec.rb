  ...
  describe '#export' do
    ...
    context 'when paid is true' do
      ...
      it 'returns hash with refund true and date_fee_paid set' do
        expect(subject).to eql(refund: true, date_fee_paid: date_paid, calculation_scheme: Rails.configuration.ucd_schema)
      end
    end
    ...
    context 'when paid is false' do
      ...
      it 'returns hash with refund false dna date_fee_paid nil' do
        expect(subject).to eql(refund: false, date_fee_paid: nil, calculation_scheme: Rails.configuration.ucd_schema)
      end
    end
  end
