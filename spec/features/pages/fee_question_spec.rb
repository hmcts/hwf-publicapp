  ...
  context 'when accessing the "fee" page for "Help with fees"' do
    ...
    context 'completing a non-refund form correctly' do
      ...
      scenario 'I expect to be routed to the "form name" page' do
        expect(page).to have_content 'What number is on your court or tribunal form?'
      end
    end
    ...
    context 'not completing the page correctly' do
      ...
      describe 'selecting yes to fee paid' do
        ...
        describe 'when the date is too old' do
          ...
          scenario 'I expect the fields to have specific errors' do
            expect(page).to have_xpath('//span[@class="govuk-error-message"]', text: 'The date the fee was paid must have been within the last three months')
          end
