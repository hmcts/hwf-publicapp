class PartnerNationalInsurancePage < BasePage
  ...
  section :content, '#content' do
    ...
    element :partner_ni_number_present, 'label', text: 'My partner does not have a National Insurance number'
  end

  def submit_valid_ni
    partner_national_insurance_page.content.partner_ni_number_present.click
  ...
  def submit_no_ni
    content.partner_ni_number_present.click
    continue
  end
