class IncomeKindPage < BasePage
  ...
  section :content, '#content' do
    ...
    element :choose_income_single, 'div.govuk-hint', text: 'Choose the different types of income you received at the time you paid the fee.'
    element :choose_income_married, 'div.govuk-hint', text: 'Choose the different types of income you and your partner received at the time you paid the fee.'
